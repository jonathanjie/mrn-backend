...
class Ship(models.Model):
    ...
    cruising_range_distance = models.DecimalField(max_digits=10, decimal_places=2)
    cruising_range_days = models.DecimalField(max_digits=5, decimal_places=2)
    trial_speed = models.DecimalField(max_digits=5, decimal_places=2)
    service_speed = models.DecimalField(max_digits=5, decimal_places=2)
    daily_fuel_consumption = models.DecimalField(max_digits=5, decimal_places=2)
    ballast = models.BooleanField()
    load = models.BooleanField()
    main_engine_no = models.IntegerField()
    mcr = models.DecimalField(max_digits=5, decimal_places=2)
    imo_tier = models.CharField(max_length=1)
    fuel_type = models.CharField(max_length=127)
    generator_type = models.CharField(max_length=127)
    generator_rpm = models.IntegerField()
    generator_power = models.DecimalField(max_digits=5, decimal_places=2)
    generator_set = models.IntegerField()
    boiler = models.CharField(max_length=127)
    cargo_tanks = models.IntegerField()
    cargo_capacity = models.DecimalField(max_digits=5, decimal_places=2)
    ...
    propeller_blade = models.IntegerField()
    propeller_set = models.IntegerField()
    btws_is_fitted = models.BooleanField()
